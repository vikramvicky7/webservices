...
function getPosts() {
    fetch('http://localhost:8080/webservices/webapi/postbook/posts/all')
        .then(res => res.json())
        .then(res => {
            posts = res;
            mapPosts();
...
function addPost() {
    fetch('http://localhost:8080/webservices/webapi/postbook/posts/add', {
        method: 'POST',
        body: JSON.stringify({
            id: 0,
...
function deletePost(id,index) {
    fetch('http://localhost:8080/webservices/webapi/postbook/posts/delete/' + id, {
        method: 'DELETE',
    })
        .then(res => res.json())
        .then(res => {
